...
public class WorkoutService {
    ...
    public Page<WorkoutResponse> getWorkoutList(int pageSize, int pageNumber){
        var pageable=PageRequest.of(pageNumber,pageSize);
        var data= repository.findAll(pageable);
        return data.map(WorkoutToWorkoutResponse::map);
    }

    public WorkoutResponse addWorkout(WorkoutRequest request) throws IOException, CustomException {
